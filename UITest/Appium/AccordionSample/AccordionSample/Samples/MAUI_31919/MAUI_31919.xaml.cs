...
public partial class MAUI_31919 : Shell
{
    ...
    [Obsolete]
    //public ICommand HelpCommand => new Command<string>((url) => DeviceDisplay.Current..OpenUri(new Uri(url)));
    public ICommand HelpCommand => new Command<string>((url) => Launcher.OpenAsync(new Uri(url)));
