...
public abstract class BaseTest : UITestData
{
    ...
    public override IConfig GetTestConfig()
    {
        ...
        var appIdentifier = "com.companyname.bindablelayout";
        var AppMain1 = "AppMain";
        var AppMain12 = "crc64248deaf1ba629458";
        ...
        if (_testDevice == TestDevice.Windows)
        {
            ...
            var appIdentifier1 = "BindableLayout";
        ...
        if (_testDevice == TestDevice.Mac)
        {
            ...
            var MacappnameID = "com.companyname.bindablelayout";
        ...
        if (_testDevice == TestDevice.iOS)
        {
            ...
            // Note: a release build has to be done and the path to this .exe file should exist. Tweak this path if necessary
            var appIdentifier1 = "com.companyname.bindablelayout";
            config.SetProperty(appIdentifierKey11, appIdentifier1);
...
#if ANDROID
        Thread.Sleep(1000);
        App.TapCoordinates(75, 204);
#elif IOS
        Thread.Sleep(1000);
        App.TapCoordinates(30, 73);
#endif
        Thread.Sleep(1000);
    }
...
#if ANDROID
        Thread.Sleep(1000);
        App.TapCoordinates(1028, 229);
#elif IOS
        Thread.Sleep(1000);
        App.TapCoordinates(364, 66);
