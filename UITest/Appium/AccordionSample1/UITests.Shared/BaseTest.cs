...
public abstract class BaseTest : UITestData
{
    ...
    public override IConfig GetTestConfig()
    {
        ...
        var appIdentifier = "com.companyname.accordionsample1";
        var AppMain1 = "AppMain";
        var AppMain12 = "crc6462027ccaaf4c2ae4";
        ...
        if (_testDevice == TestDevice.Windows)
        {
            ...
            var appIdentifier1 = "AccordionSample1";
        ...
        if (_testDevice == TestDevice.Mac)
        {
            ...
            var MacappnameID = "com.companyname.accordionsample1";
        ...
        if (_testDevice == TestDevice.iOS)
        {
            ...
            // Note: a release build has to be done and the path to this .exe file should exist. Tweak this path if necessary
            var appIdentifier1 = "com.companyname.accordionsample1";
            config.SetProperty(appIdentifierKey11, appIdentifier1);
    ...
    public void NavigateToHome()
    {
        try
        {
            ...
            App.TapBackArrow();
#endif
            App.WaitForElement("Load_RTL_sample", timeout: TimeSpan.FromSeconds(2));
            Thread.Sleep(500);
        }
        catch
        {
